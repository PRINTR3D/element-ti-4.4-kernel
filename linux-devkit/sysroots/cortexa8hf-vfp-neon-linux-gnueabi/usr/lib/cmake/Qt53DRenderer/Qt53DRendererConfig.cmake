...
get_filename_component(_realOrig "/usr/lib/cmake/Qt53DRenderer" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt53DRenderer_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::3DRenderer)
    ...
    set(_Qt53DRenderer_OWN_INCLUDE_DIRS "${_qt53DRenderer_install_prefix}/include/qt5/" "${_qt53DRenderer_install_prefix}/include/qt5/Qt3DRenderer")
    set(Qt53DRenderer_PRIVATE_INCLUDE_DIRS
        "${_qt53DRenderer_install_prefix}/include/qt5/Qt3DRenderer/5.5.0"
        "${_qt53DRenderer_install_prefix}/include/qt5/Qt3DRenderer/5.5.0/Qt3DRenderer"
    )
    ...
    macro(_populate_3DRenderer_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt53DRenderer_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_3DRenderer_check_file_exists(${imported_location})
